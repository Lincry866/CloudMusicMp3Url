...
d = d.AES = p.extend({
    bbr: function() {
        ...
        c = a.words,
        d = a.sigBytes / 4,
        a = 4 * ((this.bOU = d + 6) + 1), e = this.bOT = [], j = 0; j < a; j++) if (j < d) e[j] = c[j];
        else {
            var k = e[j - 1];
...
function d(d, e, f, g) {
    ...
    i = a(16);
    h.encText = b(d, g),
    h.encText = encodeURIComponent(b(h.encText, i)),
    h.encSecKey = c(i, e, f),
    h
...
if (type == 0) {
    hanshu = "{'ids':[" + id + "],'br':128000,'csrf_token':''}";
} else if (type == 1) {
    hanshu = "{'id':" + id + ",'lv':-1,'tv':-1,'csrf_token':''}";
} else if (type == 2) {
    hanshu = "{'s':'" + id + "','limit':'8','csrf_token':''}";
}
var nb = d(hanshu, "010001", "", "0CoJUm6Qyw8W8jud");
return nb;
} //0=歌曲 1=歌词 2=搜索
